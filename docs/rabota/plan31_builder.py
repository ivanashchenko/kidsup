...
# ── ПРИОРИТЕТ 2
A(f"<h2>2. Весь день — Елена. {len(Z)} заявок, которым не ответили</h2>")
A("<div class='card alarm'>Это главный резерв дня. Люди оставили телефон сами — "
  "и не получили ответа. Начинать с самых старых: чем дольше молчим, тем холоднее.</div>")
