...
A("<div class='q'>«Доброе утро! Это KidsUP. Сегодня в ЧЧ:ММ ждём [имя] на первое занятие. "
  "Бульвар Рокоссовского 6 к1В, БЦ «Богородский», 7-й подъезд (домофон 12), 2 этаж, из лифта налево — код от двери центра 667788#. "
...
A("<div class='card ok'><b>−10% на первый абонемент действует только сегодня, в день пробного.</b> "
  ...
  "<a href='/static/tablichka_skidka.pdf'>ПЕЧАТЬ: табличка со скидкой (PDF, A4)</a> "
  "или <a href='/base/tablichka_skidka'>смотреть на экране</a>. Родитель видит цифру сам, спорить с бумагой сложнее.</div>")
...
A("<h2>Тетради для подготовки к школе — с сегодня</h2>")
A("<div class='card ok'><b>Цена тетради — 500 ₽</b> (в прошлом году было 450, "
  "с этого года 500). Решение владельца, 31.08.<br><br>"
  "<b>Кому:</b> всем, кто идёт первый год подготовки к школе.<br>"
  "<b>Когда:</b> только ПОСЛЕ оплаты абонемента — не раньше.<br>"
  "<b>Что выдаём:</b> комплект из трёх тетрадей — «Складарь», "
  "«Интеллектуальный уровень 1», «Линии-штриховки 1». Итого 1 500 ₽ за комплект.</div>")
A("<div class='q'>«К первому году подготовки идёт комплект рабочих тетрадей — "
  "три штуки по 500 рублей. Они нужны на каждом занятии, педагог по ним ведёт. "
  "Добавляю к абонементу?»</div>")
A("<p class='small'>Подготовить пачками по 15 штук и держать у стойки — "
  "есть нераспечатанная коробка, её никто не пересчитывал. "
  "Деньги за тетради принимаем отдельно от абонемента.</p>")
