...
for c in SHOW:
    ...
    for title,old,new_ in lines:
        ...
        disc = "—" if c in ("Робототехника","Логопед","Английский детский сад") else f"<b>{_f(round(new_*0.9))}</b>"
...
A("<p class='small'>Цены — из прайса kidsup.ru/price, действуют с 1 сентября. "
  ...
  "У мини-сада и нулевого класса своя механика: бесплатный пробный день, "
  "затем пробная неделя с зачётом стоимости при покупке месяца в течение 3 дней — "
  "не путать с −10%. "
