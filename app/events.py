...
WEEK = {"пн": "понедельник 1 сентября", "вт": "вторник 2 сентября",
        "ср": "среда 3 сентября", "чт": "четверг 4 сентября",
        "пт": "пятница 5 сентября", "сб": "суббота 6 сентября",
        "вс": "воскресенье 31 августа"}
