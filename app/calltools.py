...
FOREIGN = {"21"}
PARTNER = {"20"}  # Надежда, Клуб Буракова — звонит по нашей базе
...
EXT_DEFAULT = {"10": "Ира", "12": "Лена", "15": "Аня", "20": "Надежда"}
...
def who_for_ext(ext: str, day: str | None = None) -> str:
    ...
    # Добавочный Надежды закреплён жёстко: она не в графике смен центра
    # и сидит в Люберцах, поэтому правило «один на смене — все добавочные
