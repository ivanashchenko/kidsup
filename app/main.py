...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("__url:/static/banner_metro_print.png", "🚇 БАННЕР В МЕТРО — 4 направления",
         "Подготовка, английский, мини-сад и нулевой класс на одном плакате. Печатное качество 4000×5600"),
