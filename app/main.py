...
DOC_GROUPS = [
    ...
    ("Каждый день на смене", [
        ...
        ("obzvon_nadezhda", "📞 Обзвон для Надежды: возраст подготовки к школе",
         "161 семья: ходили у нас в прошлом учебном году или были этим летом, "
...
APP_VERSION = "2026-08-23.18"  # видно в /api/health — чтобы проверять, что обновление применилось
