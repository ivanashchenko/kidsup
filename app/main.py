...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("obzvon_aya_4_5", "🎯 Обзвон: английский 4–5 лет, группа Ильи (вт-чт 18:00)",
         "По запросу Иры 06.09: дети 3 г 8 мес – 6 лет без английского в этом сезоне. A — заявки на АЯ без записи, "
         "B — наши клиенты на других направлениях (второй предмет −10%), C — были на АЯ в прошлом сезоне, D — лиды. "
         "Телефоны, текущие группы, ссылки в CRM, фразы для звонка"),
