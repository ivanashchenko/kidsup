...
DOC_GROUPS = [
    ...
    ("Каждый день на смене", [
        ...
        ("pravila_kidsup", "📋 Правила посещения KidsUP",
         "Для ресепшена и старт-пакета: быт, запись, оплата, скидки. Плюс четыре решения "
         "по отработкам, заморозке и возвратам — на подпись Борису"),
...
APP_VERSION = "2026-08-20.14"  # видно в /api/health — чтобы проверять, что обновление применилось
