...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("spisok_final", "🎯 ФИНАЛЬНЫЙ список — кому ни разу не звонили",
         "29 платившиx семей, которым не звонили ни разу по набору 2026/27: "
         "сверено со всеми звонками с 16.08 включая 28-29.08, никто не записан "
         "в группы нового года, отказы и «не звонить» убраны"),
