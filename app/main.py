...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("kabinety_zamena_0809", "🏫 Кабинеты и замены групп — сетка недели 8 кабинетов × часы, план «только замены» (решение Бориса 08.09)",
         "Факт: в пик будней заняты 4 кабинета из 8, К5–К8 пустуют всю неделю. Три замены в существующих слотах, две снятые, чем занять пустые кабинеты (педагоги, партнёры, логопед утром)."),
