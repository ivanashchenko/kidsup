...
DOC_GROUPS = [
    ("Настройка системы", [
        ("podklyuchenie_modeli", "🔌 Подключение модели: пошагово",
         "Как включить разбор смыслом вместо поиска по словам: ключ Anthropic, "
         "прокси на Cloudflare и три настройки. Один раз, около 20 минут"),
    ]),
    ("Планы и деньги", [
    ...
    ("Каждый день на смене", [
        ...
        ("blanki_obzvona", "🖨 Бланки для обзвона: расписание, цены, контакты",
         ...
         "и ответы на частые вопросы. Для Надежды и для работы без компьютера"),
        ("megaplan", "🎯 Мега-план набора до 30 сентября",
         "Всё в одном месте: честная математика по трём сценариям, что уже "
         "работает и что берём из марафона, календарь по неделям и числа, "
         "по которым видно, работает ли план"),
        ...
        ("napisat_spisok", "✍️ Написать: звонки не помогли",
         "Семьи, до которых не дозвонились. Одна задача вместо десяти "
         "одинаковых: открыть переписку и предложить занятие"),
        ...
        ("tri_ocheredi", "🔍 Три очереди: почему задачи закрываются без касания",
         ...
         "по одному. 35 из 54 звонков за смену не видны ни в одном списке"),
        ("shablony_wazzup", "💬 Шаблоны Wazzup: быстрые ответы админов",
         "27 готовых текстов с нумерацией по разделам: возраст, предметы, "
         "организационное, события, ответы на сомнения. Цены из единого "
         "прайса. Скопировать в кабинет Wazzup, старые пометить «архив»"),
        ("list_anya_sad", "📋 Лист Ани — мини-сад и нулевой класс",
         "57 семей: все, кто когда-либо ходил, пробовал или оставлял заявку "
         "на мини-сад либо нулевой класс и не записан туда на 2026/27. "
         "Малыши сверху, у каждого — куда звать по возрасту"),
        ("list_lena", "📋 Лист Лены — доб. 12 (Катя и Инга)",
         "100 семей: занимались у Кати или Инги на подготовке, плюс добор "
         "из возрастного листа. Те, с кем говорили накануне, вычтены"),
        ("list_burakov", "📋 Лист Клуба Буракова — доб. 20",
         "100 семей из базы KidsUP, кроме подопечных Кати и Инги. "
         "Те, с кем говорили накануне, вычтены"),
        ("list_irina", "📋 Лист Ирины — доб. 10 (английский 7-12)",
         "90 семей: английский, ребёнку 7-12 лет к 1 сентября, платили за "
         "последние два года, на новый год не записаны. Свежие сверху"),
        ("obzvon_vozrast", "🎯 Обзвон по возрастам: кто у нас платил",
         "370 семей: полный абонемент на месяц в 2025/26 или неделя лагеря "
         "этим летом, на новый год не записаны. По возрастным блокам, "
         "у каждого — что посещал, куда звать в первую очередь и куда "
         "во вторую. Место для записи от руки, печатать в альбомной"),
        ("obzvon_nadezhda", "📞 Обзвон для Надежды: возраст подготовки к школе",
         "136 семей: ходили у нас в прошлом учебном году или были этим летом, "
         "ребёнку к 1 сентября 4–7 лет, на новый сезон никуда не записаны. "
         "Тёплые первыми, у каждого — что было у нас и когда. "
         "Печатать в альбомной ориентации, итог разговора вписывается от руки"),
        ("obzvon_psh", "🎯 Обзвон ПШ: лист владельца на 22–23.08",
         "238 семей, которые уже занимались у нас в подготовке к школе и на новый "
         "сезон никуда не записаны: 103 целевого возраста на выходные, остальные "
         "отдельной волной. Скрипт разговора, ссылки на карточки и отметка результата"),
...
APP_VERSION = "2026-08-24.22"  # видно в /api/health — чтобы проверять, что обновление применилось
