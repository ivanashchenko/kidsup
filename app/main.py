...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("__url:/static/tablichka_skidka.pdf", "🖨 ТАБЛИЧКА СКИДКИ — PDF на печать",
         "Готовый A4: скидка в день первого занятия, цены по всем направлениям, мини-сад и нулевой класс с −5%. Печатать и класть на стойку"),
        ("tablichka_skidka", "🖨 ТАБЛИЧКА НА СТОЙКУ — скидка −10% и цены",
