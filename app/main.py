...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("gruppy_2627", "📊 ГРУППЫ 2026/27 — заполнение по каждой",
        ...
        ("plan_31avgusta", "🎯 ПОНЕДЕЛЬНИК 31.08 — план дня (Елена и Ирина)",
         "Первый день учебного года: кого обзвонить до 10:00, кому сказать что занятия позже (ИЗО со среды, логопед с 7.09), перебор в английском 19:00 и как дожимать до абонемента прямо на выходе с занятия"),
