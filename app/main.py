...
PITCH = {
    ...
    "Раннее развитие с Еленой. Музыка и речь": {
        ...
        "close": "«Ближайшая группа по возрасту — [день/время]. Первое занятие условно-бесплатное: малыш попробует, вы посмотрите формат, и платите только если понравилось»."},
    "Раннее развитие с Ириной. Первая школа": {
        ...
        "close": "«Подберу группу точно по возрасту — сколько сейчас месяцев? Первое занятие условно-бесплатное, платите только если понравится»."},
    "Лицей для малышей": {
        ...
        "close": "«По возрасту вам как раз лицей. Первое занятие условно-бесплатное — посмотрите педагога, платите только если понравится. Записываю?»"},
    "Логопед": {
...
APP_VERSION = "2026-08-16.02"  # видно в /api/health — чтобы проверять, что обновление применилось
