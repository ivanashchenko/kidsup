...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("plan_31avgusta", "🎯 ПОНЕДЕЛЬНИК 31.08 — план дня (Елена и Ирина)",
         "Полная сверка CRM: где мы на самом деле (49%, а не 60%), 52 заявки без ответа, перебор в раннем развитии и английском, дубли у логопеда — и обоснование, почему день строится именно в таком порядке"),
