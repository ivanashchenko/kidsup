...
PRICES = {
    ...
    "ИЗО-студия": {"title": "Занятие 50 мин · пробное занятие 850 ₽, в зачёт абонемента",
        "lines": [("8 занятий (2 р/нед)", 6800, 7000),
                  ("4 занятия (1 р/нед)", 4700, 4900),
                  ("Разовое занятие", 1600, 1600),
                  ("Пробное занятие (в зачёт абонемента)", 850, 850)]},
    "Шахматы": {"title": "Занятие 45 мин · пробное занятие 850 ₽, в зачёт абонемента",
        "lines": [("8 занятий (2 р/нед)", 8200, 8400),
                  ("4 занятия (1 р/нед)", 4800, 5000),
                  ("Разовое занятие", 1600, 1600),
                  ("Пробное занятие (в зачёт абонемента)", 850, 850)]},
    ...
    "Робототехника": {"title": "Занятие 55 мин · партнёрский курс, цену ставит партнёр",
        "lines": [("4 занятия", 6400, 6400),
                  ("8 занятий", 10400, 10400),
                  ("Разовое занятие", 2300, 2300),
                  ("Пробное занятие", 1600, 1600)]},
...
PITCH = {
    "Английский детский сад": {
        "what": "Мини-сад ГКП 9:00–13:00: не присмотр, а обучение — минимум 4 занятия каждый день, английский два раза в неделю, ИЗО и лепка, песочная терапия, «говорилка» для запуска речи.",
        ...
        "close": "«Первый день условно-бесплатный: не понравится — ничего не платите, понравится — этот день входит в первый месяц, а при оплате месяца в день пробного — скидка 8%. На какой день записать?»",
    ...
    "ИЗО-студия": {
        "what": "Четыре разных группы: живопись, лепка, картины великих художников, творчество для самых маленьких — не «рисование вообще», а программа.",
        "why": "Ребёнок уносит готовую работу с каждого занятия — виден результат, растёт уверенность и усидчивость.",
        "close": "«Пробное занятие 850 ₽: ребёнок нарисует первую картину, а если остаётесь — эти 850 ₽ идут в зачёт абонемента. На какой день записать?»",
    ...
    "Шахматы": {
        ...
        "close": "«Пробное занятие 850 ₽: педагог посмотрит уровень и определит в группу, а если остаётесь — 850 ₽ идут в зачёт абонемента. Записываю?»",
    ...
    "Робототехника": {
        ...
        "close": "«Пробное 1 600 ₽ (партнёрский курс) — соберёт первого робота и всё поймёт сам. Абонемент 6 400 ₽ за 4 занятия или 10 400 ₽ за 8. Записать на ближайшее?»",
...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("english_standard", "🇬🇧 Английский: стандарт курса и разбор чата педагогов",
         "Три несостыковки, которые надо закрыть решением: что продано родителю против того, "
         "что поручено педагогу; Лингвитания против готовых планов; буквы. Плюс единая линейка "
         "учебников, система замера из пяти точек, список закупок и живые группы на сегодня"),
        ...
        ("__url:/static/plakaty_kidsup.pdf", "🖼 Плакаты А4 по всем направлениям (PDF)",
         "13 плакатов для печати: все предметы плюс формирующиеся группы "
         "(робототехника, танцы, скорочтение). Живое расписание и свободные "
         "места из CRM на момент сборки"),
        ("__url:/static/forma_zapisi.pdf", "📝 Форма записи на День открытых дверей (PDF)",
         "Два листа: все 10 демо-занятий 30.08 по слотам (раннее развитие, "
         "подготовка, английский, робототехника) плюс лист записи на пробное "
         "31.08-13.09 для остальных направлений. Печатать 3-4 комплекта"),
        ("dod_gosti", "🚪 ДОД 30.08 — кто придёт",
         "Гости Дня открытых дверей из звонков и переписок: подтверждённые "
         "визиты, слоты уроков, кого дожать. Плюс правило, как фиксировать "
         "новых гостей"),
        ("__url:/static/anketa_prazdnik.pdf", "🎁 Анкета праздника 29.08 (PDF)",
         "Готовый файл на печать — двусторонняя А4, 300 копий, переплёт по "
         "короткой стороне"),
        ("anketa_prazdnik", "🎁 Анкета праздника 29.08 — печать",
         "Двусторонняя А4: лицо — анкета (контакты, интересы, согласие на "
         "связь) в обмен на вращение барабана с игрушками, оборот — рекламка "
         "всех 13 направлений. Печатать 300 шт., после праздника — Лизе в CRM"),
        ("__url:/static/dod_rannee_razvitie.pdf", "🧸 РР на ДОД — исправлено по возрасту (PDF)",
         "Ирина ведёт 1,3-3 года двумя слотами: до 2 лет в 11:00, от 2 до 3 в "
         "12:00. Кого переносим, кого отдаём Елене в «Лицей для малышей», "
         "и что говорить родителям"),
        ("__url:/static/pasport_psh1.pdf", "💙 ПАСПОРТ РАЗВИТИЯ — подготовка, 1-й уровень (PDF)",
         "Комплект родителю на 4 страницы: обложка с именем ребёнка, как мы учим, маршрут года по месяцам и три отметки педагога — сентябрь, декабрь, май"),
        ("__url:/static/pasport_psh2.pdf", "💙 ПАСПОРТ РАЗВИТИЯ — подготовка, 2-й уровень (PDF)",
         "То же для читающих детей: от слова к тексту, печатные буквы, вычисления до автоматизма"),
        ("__url:/static/karty_razvitiya.pdf", "🗺 КАРТЫ РАЗВИТИЯ — что ребёнок освоит за год (PDF)",
         "Три листа для родителей: подготовка 1-й уровень, подготовка 2-й уровень и Лицей для малышей 3–4 года. Помесячно: чтение, письмо, математика, интеллект"),
        ("__url:/static/metodichka_probnoe.pdf", "🖨 МЕТОДИЧКА ПРОБНОГО — PDF на печать",
         "Девять шагов занятия, английский по технологии Осетровой, темы по возрастам, фразы-запреты и связка педагог—администратор"),
        ("__url:/static/diagnostika_metodichka.pdf", "🖨 ДИАГНОСТИКА — методичка PDF",
         "Как проводить диагностику на первом занятии и превращать её в абонемент"),
        ("diagnostika", "🔍 ДИАГНОСТИКА НА ПЕРВОМ ЗАНЯТИИ — как проводить",
         "Что смотрит педагог в подготовке и английском, как заполнять бланк и как администратор превращает его в абонемент. Плюс PDF бланков на печать"),
        ("__url:/static/diagnostika_blanki.pdf", "🖨 БЛАНКИ ДИАГНОСТИКИ (PDF, 3 листа)",
         "Лист педагога по подготовке, лист педагога по английскому и лист «Что мы увидели у вашего ребёнка» для родителя"),
        ("angliyskiy", "🇬🇧 АНГЛИЙСКИЙ — записи по группам",
         "8 групп по кембриджским уровням: мест, записей, заявок, свободно. Поимённо кто в какой группе"),
        ("gruppy_2627", "📊 ГРУППЫ 2026/27 — записи по каждой группе",
         "Все 79 групп в одной таблице: мест, записано, свободно, заполненность "
         "полосой. Раннее развитие разделено по педагогам. Видно, где перебор, "
         "а где группа стоит пустая"),
        ("__url:/static/tablichka_skidka.pdf", "🖨 ТАБЛИЧКА СКИДКИ — PDF на печать",
         "Готовый A4: скидка в день первого занятия, цены по всем направлениям, мини-сад и нулевой класс с −8%. Печатать и класть на стойку"),
        ("tablichka_skidka", "🖨 ТАБЛИЧКА НА СТОЙКУ — скидка −15% и цены",
         "Печатать на A4 вертикально и держать на ресепшене: скидка в день первого занятия, цены по всем направлениям с зачёркнутой старой и крупной новой"),
        ("__url:/static/banner_metro.png", "🚇 БАННЕР В МЕТРО — как будет в коробе 2000×1500",
        ...
        ("zameny_grupp_0809", "🔁 Замены групп: что закрыть и что поставить вместо — 4 кабинета, тот же слот (08.09 вечер)",
         "Кабинетов четыре, вечер занят на 100%: новая группа только на место закрытой. Ранжированные замены с педагогом, спросом и переводом детей; что не трогать; открытия утром и в выходные."),
        ("kabinety_zamena_0809", "🏫 Кабинеты: сетка недели К1–К4 × часы (08.09, исправлено на четыре кабинета)",
         "Факт: вечер будней занят на 100% — все четыре кабинета каждый час; свободно утро после 12:00 и выходные. Сетка по дням и часам, что можно поставить в свободные слоты."),
        ("gruppy_strategiya_0809", "🎯 Группы: стратегия выручки и прибыли на 30.09 — добрать или сливать, по каждой группе (08.09)",
         "Четыре независимые стратегии (продажи, финансы, цены, расписание), три судьи и скептик → одно решение: 5 слияний, 25 групп добираем, 3 новые; сценарии 185 / 182 / 202 / 204 оплат, план по неделям, восемь решений Бориса."),
        ...
        ("karta_progressa_v2", "🗺 Карта прогресса ученика — полный регламент (v2, 07.09)",
         "Шесть точек контакта: что и когда получает родитель; роли и минуты; вехи по каждому предмету; тексты сообщений; инструменты; запуск по неделям; четыре решения Бориса."),
        ("karta_dnevnik_sistema", "🌱 Карта развития и дневник достижений — система видимого прогресса",
         "Четыре точки, где родитель видит результат: день 1, каждое занятие, 3-я неделя, конец абонемента. Практики Kumon, EYFS, Seesaw, Cambridge и наши тренинги; роли, время, печать, метрики, решения Бориса"),
        ...
        ("plan_06sen", "🎯 ВОСКРЕСЕНЬЕ 06.09 — тактика Ане и Ире: первые занятия МА и РР, подтверждение 13 первых занятий понедельника, экскурсии в сад",
         "Аня — оплаты на выходе, 13 подтверждений на пн голосом, остаток дожима. Ира — явка, экскурсии в сад/НК (3 назначить), окно базы 40 наборов (семьи 121–160), записи в CRM с флажком «пробное». Шахматы и робототехника — по решению Бориса"),
        ("yuz_keysy", "💬 Юз-кейсы: три истории семей до пятницы",
         "Кто, скрипт для Лизы, согласие, подарок, структура текста и план до пятницы"),
        ("gruppy_reshenia", "🧩 Группы 2026/27: открыть, переформатировать, закрыть",
         "Разбор всех 54 групп с цифрами: слияния ПШ и ИЗО, разгрузка АЯ и РР, новые группы по буферам, экономика и таблица отработки"),
        ("strategiya_nedelya", "🗓 Стратегия недели 7–13 сентября",
         "Где стоим по направлениям, четыре ставки недели, что решает Борис, режим админов, что нужно от педагогов, календарь и KPI недели"),
        ("strategiya_sentyabr", "🧭 ПОЛНЫЕ ГРУППЫ К 30.09 — что делать: диагноз, пять рычагов, план по неделям",
         "Сводка всего на 04.09: 61% живых, 33% оплачено, нужно +89 живых и +192 оплаты. SWOT по данным, пять рычагов с деньгами (дожим 103 семей, доходимость 80%, база 40/день, расписание под спрос, сарафан и точечный Директ), топ-5 недели с владельцами, контрольные точки, семь ежедневных цифр, решения Бориса, три сценария"),
        ("plan_04sen", "🎯 ПЯТНИЦА 04.09 — план Ане и Ире: проблемы четырёх дней, робототехника и шахматы",
         "Поручения Бориса до 12:00: робототехника — 1 или 2 раза в неделю (15 заявок), шахматы сегодня не идут (5 записанных предупредить). Воронка 31.08–03.09, девять проблем и что с ними делать, дожим Ани, реактивация Иры 41–80, хвосты со вчера"),
        ("plan_03sen", "🎯 ЧЕТВЕРГ 03.09 — задания Лене и Ане по стратегии",
         "Лена — дожим 5 «пришли, не купили» и оплаты на выходе; Аня — окно реактивации 13:00–16:00: 40 бывших плательщиков под полупустые группы ПШ, отметка явки, 18 не дошедших. Кто сегодня на первом занятии"),
        ("itog_3dnya", "📊 ИТОГ НЕДЕЛИ ОТКРЫТЫХ УРОКОВ 31.08–02.09 и стратегия на сентябрь",
         "60 детей на пробных: доходимость 67%, купили 78% пришедших, 494 тыс ₽. Заполненность 79 групп, кого догонять, шесть шагов набора с расчётом денег"),
        ("plan_02sen", "🎯 СРЕДА 02.09 — план дня под новый порядок (Лена и Ира)",
         "Лена — только дожим и оплаты, Ира — встреча, проводы и окно 13:00–16:00 под списки. Метрика: доля оплат от пришедших на пробное (порог 40%), кто сегодня на первом занятии, кого дожимать со вчера"),
        ("zadachi_02sen", "✅ Задачи 02.09 отдельным списком (входят в план дня)",
         "Те же 25 задач, что и в плане на среду, без остального. Нужен, только если хочется распечатать один список"),
        ("plan_01sen", "🎯 ВТОРНИК 01.09 — план дня (Лена и Аня)",
         "Лена на ресепшене: переносы со вчера, подтверждения, дожим, неявки. Аня на телефоне: свои хвосты, потом ДОД, Праздник и летние. Плюс что горит сейчас"),
        ("plan_31avgusta", "🎯 ПОНЕДЕЛЬНИК 31.08 — по шагам для Иры и Лены",
         "Лена на ресепшене, Ира на телефоне. Три списка по порядку: дожать вчерашний ДОД, заявки с Праздника, летние и прошлогодние. Плюс скрипты дожима до абонемента"),
        ("bonusy_gonka", "🏆 БОНУСЫ ИРЫ И АНИ — неделя на 67 500 ₽",
         "Сколько заработано сейчас, сколько лежит на столе по каждому дню недели и почему один и тот же ребёнок стоит 300, 450 или 600 ₽"),
        ("nedelya_31avg", "📅 НЕДЕЛЯ 31.08–13.09 — смены, план, бонусы",
         "График смен на неделю, итоги воскресенья, план на первый день "
         "занятий и полный расчёт бонусов Ани и Иры по дням: сколько сейчас, "
         "сколько за дошедших до пробного, сколько за купивших сразу"),
        ("plan_30avgusta", "📞 ОБЗВОН 30.08 — Аня и Лена",
         "Что прозванивать в воскресенье: до 11:00 подтверждения записанных на "
         "ДОД, после 15:00 — 82 семьи с анкет праздника. Списки поделены, "
         "скрипты и предупреждения по логопеду и танцам"),
        ("__url:/static/dod_30avgusta.pdf", "🖨 ДОД 30.08 — расписание и списки (PDF)",
         "На печать: все 10 слотов с записавшимися, телефоны, колонка «пришёл» "
         "для отметок и список расхождений, которые надо уточнить при встрече"),
        ("dod_svod", "🚪 ДОД 30.08 — ЕДИНЫЙ список записанных",
         "Два рукописных листа админов плюс ранние заявки сведены в один "
         "список по слотам: кто записан, есть ли в базе, где расходятся "
         "телефоны и кого записали дважды"),
        ("chek_sentyabr", "✅ ЧЕК-ЛИСТ: закрыть 180 мест до 30 сентября",
         "Всё, что нужно сделать, по важности и срочности: что горит сегодня, "
         "какие решения ждут Бориса, где лежат свободные места, кого обзванивать "
         "и что чинить в Манго, Roistat и МойКласс"),
        ("spisok_final", "🎯 ФИНАЛЬНЫЙ список — кому ни разу не звонили",
         "71 семья: все, кто платил летом 2026 или в учебном году 2025/26 (506), "
         "минус контакты с 16.08 по выгрузке Манго (387), минус записанные в "
         "2026/27 (37) и стоп-статусы (10)"),
        ...
        ("obzvon_aya_4_5", "🎯 Обзвон: английский 3–5 и 6–8 лет — 323 семьи, две половины",
         "По запросу Иры 06.09: две возрастные полосы, в каждой A — заявки на АЯ без записи, B — наши клиенты на других "
         "направлениях (второй предмет −10%), C — ходили на АЯ в прошлом сезоне, D — лиды. Куда записывать по возрасту и уровню, "
         "телефоны, текущие группы, ссылки в CRM, фразы. Половина 1 — Аня/Лена, половина 2 — Ира"),
    ...
    ("Владельцу", [
        ...
        ("waba_shablony", "📨 Шаблоны WABA, которые должны пройти",
         "Почему Meta отклонила все версии 04.09, пять маркетинговых и четыре сервисных текста без списков и дат, порядок подачи по одному, настройки при подаче, кнопка «скопировать»"),
...
def api_tvoyklass_dosly(payload: dict = Body(default={})):
    ...
    from . import tvoyklass
    return tvoyklass.dosly(dry=not payload.get("send"))


@app.post("/api/tvoyklass/unhold", dependencies=AUTH)
def api_tvoyklass_unhold():
    """Вернуть отложенные номера рассылки «Твой Класс» в очередь."""
    from . import tvoyklass
    return tvoyklass.unhold()
...
_ZAYAVKI_KEYS = [
    # ключ из формы сайта → ТОЧНОЕ имя буферной группы (без префикса 2627_).
    # Порядок важен: «Английский мини-сад» и «Нулевой класс» должны уйти
    # в сад, а не в английский. Сверено со списком групп 01.09.
    ("английский мини-сад", "Мини-сад_Заявки"),
    ("мини-сад",            "Мини-сад_Заявки"),
    ("нулев",               "НК_Заявки"),
    ("подготовк",           "ПШ_Заявки"),
    ("англ",                "АЯ_Заявки"),
    ("шахмат",              "ШАХ_Заявки"),
    ("робот",               "Заявки_Робототехника"),
    ("изо",                 "ИЗО_Заявки"),
    ("логопед",             "ЛГ Марина_Заявки"),
    ("скорочт",             "Заявки_Скорочтение"),
    ("каллиграф",           "Заявки_Каллиграфия + грамота"),
    ("ментальн",            "МА_Заявки"),
    ("первая школа",        "РР.Первая школа_Заявки"),
    ("лицей",               "РР.Лицей_Заявки"),
    ("раннее",              "РР.Музыка и речь_Заявки"),
    ("танц",                "Заявки_Танцы"),
    ("хореограф",           "Заявки_Хореография"),
    ("футбол",              "Заявки_Футбол"),
    ("единоборств",         "Заявки_Единоборства"),
    ("акробат",             "Заявки_Акробатика"),
    ("актёрск",             "Заявки_Актёрское мастерство"),
    ("актерск",             "Заявки_Актёрское мастерство"),
    ("техника речи",        "Заявки_Техника речи"),
]
...
def api_mesta_voronka():
    ...
    # статус CRM «не пришёл», но уже перезаписан на будущую дату — ждём
    rebooked = [r for r in out["не пришёл на пробное"] if (r.get("пробное") or {}).get("вид") == "ждём"]
    out["не пришёл на пробное"] = [r for r in out["не пришёл на пробное"] if r not in rebooked]
    booked += rebooked
    ...
    # Владелец 16.09: «тут удали что уже сделано». Раньше сделанные строки
    # оставались в таблице серыми внизу стадии — и их приходилось глазами
    # отделять от работы, а счётчики стадий считали их за работу. Теперь они
    # уходят из списков совсем, в отдельный свёрнутый блок внизу страницы:
    # проверить, кто и что закрыл, по-прежнему можно, но в работе их нет.
    ...
    for k, lst in out.items():
        ...
        for r in lst:
            ...
            if c.get("человек") and (c.get("ts") or "") >= start:
                done_n += 1
                done_rows.append({**r, "стадия": k, "сделано": True})
                continue
            r["сделано"] = False
            keep.append(r)
        lst[:] = keep
...
def nabor_page(request: Request):
...
def api_zayavki():
    """Необработанные заявки сезона (см. app/zayavki.py) — то же, что блок на плане дня."""
    from . import zayavki
    return zayavki.collect()
...
@app.get("/izo", response_class=HTMLResponse)
def izo_page():
    """ИЗО-студия: четыре темы, 3,5–11 лет."""
    return _lp("izo.html")
...
async def week_preview():
    """Лендинг Недели открытых уроков 31.08–13.09 — для kidsupweek.ru.
...
поэтому «три недели за год» до сих пор посчитать было нельзя.
