...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("list_burakov", "📋 Лист Клуба Буракова — доб. 20",
         "100 семей из базы KidsUP, кроме подопечных Кати и Инги. Те, с кем говорили накануне, вычтены"),
...
APP_VERSION = "2026-08-25.01"  # видно в /api/health — чтобы проверять, что обновление применилось
