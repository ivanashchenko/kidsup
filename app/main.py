...
DOC_GROUPS = [
    ...
    ("Каждый день на смене", [
        ("sobytiya_29_31", "🎪 Три события 29–31.08: чек-листы и скрипты",
         "Праздник, ДОД и Неделя уроков по шагам: маршрут гостя, анкета, разбор возражений"),
...
APP_VERSION = "2026-08-19.30"  # видно в /api/health — чтобы проверять, что обновление применилось
