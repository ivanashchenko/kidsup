...
DOC_GROUPS = [
    ...
    ("Каждый день на смене", [
        ...
        ("obzvon_nadezhda", "📞 Обзвон для Надежды: возраст подготовки к школе",
         "1345 детей, которым к 1 сентября 4–7 лет и которые никуда не записаны "
         "на новый сезон. Тёплые первыми, у каждого — что было у нас и когда. "
...
APP_VERSION = "2026-08-22.28"  # видно в /api/health — чтобы проверять, что обновление применилось
