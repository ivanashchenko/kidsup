...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("__url:/static/forma_zapisi.pdf", "📝 Форма записи на открытые уроки (PDF)",
         "Печатный лист записи по слотам 30.08 + талоны гостю с адресом и "
         "временем + место для тех, кто хочет другое занятие. Печатать 2-3 "
         "комплекта на праздник и на ДОД"),
