...
DOC_GROUPS = [
    ("Каждый день на смене", [
        ...
        ("plan_02sen", "🎯 СРЕДА 02.09 — план дня под новый порядок (Лена и Аня)",
         "Лена — только дожим и оплаты, Аня — встреча, проводы и окно 13:00–16:00 под списки. Метрика: доля оплат от пришедших на пробное (порог 40%), кто сегодня на первом занятии, кого дожимать со вчера"),
        ("zadachi_02sen", "✅ ЗАДАЧИ АДМИНАМ — среда 2 сентября",
         "25 задач из разборов звонков и переписок: деньги, кто ждёт ответа, что поправить в CRM, переносы. Плюс что ждёт решения владельца"),
