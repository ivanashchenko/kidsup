...
DOC_GROUPS = [
    ...
    ("Каждый день на смене", [
        ("obzvon_psh", "🎯 Обзвон ПШ: лист владельца на 22–23.08",
         "114 семей, которые уже занимались у нас в подготовке к школе и на новый "
         "сезон никуда не записаны. Скрипт разговора, включая ответ про уход "
         "Екатерины и Инги, и отметка результата прямо в листе"),
...
APP_VERSION = "2026-08-21.28"  # видно в /api/health — чтобы проверять, что обновление применилось
