...
- Скидки (22.09.2026 выровнены с решением владельца — здесь стояло −10% на
  первый абонемент, а во всех остальных местах 15%, и ассистент называл
  родителю цену на 5% выше настоящей):
  −15% на ПЕРВЫЙ абонемент при оплате в день пробного (только новым),
  у мини-сада и нулевого класса — −8%;
  −10% второй предмет, −10% второй ребёнок, −10% многодетным и семьям
  участников СВО. Скидки не суммируются — действует одна, наибольшая.
...
- Оплата маткапиталом и налоговый вычет 13% — НА ВСЕ ЗАНЯТИЯ, а не только
  на сад и нулевой класс: у центра образовательная лицензия. Здесь до
  22.09.2026 стояло «только сад и нулевой класс» — неверно, владелец
  поправил. Как это работает: семья подаёт заявление в Соцфонд, мы готовим
  договор; месяц семья сначала оплачивает сама, а после перечисления
  маткапитала мы возвращаем ей эту сумму.
