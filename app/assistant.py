...
б-р Маршала Рокоссовского, 6 к1В, напротив ТЦ «Янтарь», 5 минут от
...
- НЕДЕЛЯ ОТКРЫТЫХ УРОКОВ 14–20 СЕНТЯБРЯ. Всю неделю можно прийти на любое
  занятие по расписанию — это настоящий урок своей группы, а не
  показательный. Если спрашивают «когда можно прийти посмотреть» — зовём
  именно на неё: первое занятие условно-бесплатное и с диагностикой,
  педагог смотрит уровень ребёнка и подбирает группу.
