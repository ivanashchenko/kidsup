...
def _hint_for_lead(mk: MoyklassClient, user_id: int, join: dict) -> None:
    ...
    lines = [
        ...
        "2) Событие: занятия идут с 31.08. Первое занятие своей группы — условно-бесплатное, с диагностикой; при оплате абонемента в этот же день скидка 10%.",
        ...
        "Формулировка первого занятия — только «условно-бесплатное». Исключения: ИЗО/шахматы — пробное 850 ₽ в зачёт абонемента, танцы 850 ₽ если не остались, "
