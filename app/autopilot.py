...
ENG_PS = (
    ...
    "ребёнок говорит по-английски, регулярно проходят спикинг-дни с "
    "носителем языка, а в конце года — кембриджский экзамен YLE с "
    "международным сертификатом. На Неделе открытых уроков (31.08–06.09) "
