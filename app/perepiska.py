...
JOIN_TRIAL = 58132
DUTY = 232805
HOUR_FROM, HOUR_TO = 9, 21     # по Москве: раньше и позже не пишем
    ...
    if not subject:
        ...
        if topic in ("цена", "расписание"):
            return ("Здравствуйте! Скажите, пожалуйста, сколько лет ребёнку "
                    ...
                    "условно-бесплатное: не понравится — платить не нужно.")
        return ""
    if topic == "цена":
        ...
        return (f"Здравствуйте! Вот стоимость:\n\n{block}\n\n"
                ...
                f"Написать, какие есть время и дни?")
    if topic == "расписание":
        ...
        return (f"Здравствуйте! {subject} на новый учебный год — занятия "
                f"с 31 августа:\n\n{sched}\n\n"
                f"Скажите возраст ребёнка — подскажу, какая группа подойдёт, "
                f"и запишу на удобное время.")
    return ""
